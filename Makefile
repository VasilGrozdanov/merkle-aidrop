...
install :; forge install cyfrin/foundry-devops --no-commit && forge install foundry-rs/forge-std --no-commit && forge install dmfxyz/murky --no-commit && forge install openzeppelin/openzeppelin-contracts --no-commit
